...
func (in *Configuration) DeepCopyInto(out *Configuration) {
	*out = *in
	...
	if in.ProgressServer != nil {
		in, out := &in.ProgressServer, &out.ProgressServer
		*out = new(ProgressServer)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProgressServer) DeepCopyInto(out *ProgressServer) {
	*out = *in
	if in.Port != nil {
		in, out := &in.Port, &out.Port
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProgressServer.
func (in *ProgressServer) DeepCopy() *ProgressServer {
	if in == nil {
		return nil
	}
	out := new(ProgressServer)
